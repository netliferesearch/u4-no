      ...
      <div className="c-boxOnImage__body c-boxOnImage__body--smaller">
        <div {...classes('statement')}>
          ...
          <div {...classes('statement-bodywrapper')}>
            <a {...classes('statement-link')} href="/online-courses"><h3 {...classes('statement-title')}>Online training</h3></a>
        ...
        <div {...classes('statement')}>
          ...
          <div {...classes('statement-bodywrapper')}>
            <a {...classes('statement-link')} href="/workshops-and-events"><h3 {...classes('statement-title')}>Workshops and events</h3></a>
        ...
        <div {...classes('statement')}>
          ...
          <div {...classes('statement-bodywrapper')}>
            <a {...classes('statement-link')} href="/helpdesk"><h3 {...classes('statement-title')}>Helpdesk for partners</h3></a>
