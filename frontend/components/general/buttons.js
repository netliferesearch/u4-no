...
export const DownArrowButton = ({ onClick = () => null, text = '', modifier = 'primary' }) => (
  <button {...classes({ modifier })} onClick={onClick}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52" width={52} height={52} role="img" title="Arrow down">
...
export const CloseButton = ({ onClick = () => null, modifier = 'close', children }) => (
  <button {...classes({ modifier })} onClick={onClick} aria-label="Close modal">
    {children}
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" title="Close">
      <path
...
//     <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" title="Next">
//       <path
...
//     <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" title="Previous">
//       <path
