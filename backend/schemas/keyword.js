  ...
  fields: [
    {
      name: 'keyword',
      description:
        'All keywords must: - make sense as stand-alone words - be in English - be a feasible search term - likely apply to several resources',
      type: 'string',
    },
    {
      name: 'category',
  ...
  orderings: [
    {
      title: 'Keywords',
      name: 'keywordsAsc',
      by: [{ field: 'keyword', direction: 'asc' }, { field: 'category', direction: 'asc' }],
    },
    {
      title: 'Countries first',
      name: 'firstNameAsc',
      by: [{ field: 'category', direction: 'asc' }, { field: 'keyword', direction: 'asc' }],
    },
  ],
  preview: {
    select: {
